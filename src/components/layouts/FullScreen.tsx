  ...
  return (
    <div className="relative mx-auto flex h-screen w-full max-w-7xl flex-col items-center justify-center overflow-hidden ">
      ...
      <p className="relative z-20 mx-auto max-w-2xl py-8 text-center text-sm text-neutral-200 md:text-base">
        👋 ¡Hola! Soy Juan Pablo Medina, vivo en Córdoba, Argentina 🇦🇷 y actualmente estoy estudiando Desarrollo de Software.
Me dedico a crear y mejorar páginas web, buscando siempre brindar soluciones efectivas y adaptadas a las necesidades de mis clientes.
      </p>
      ...
      <div className="relative z-20 flex flex-wrap items-center justify-center gap-4 pt-4">
        <a 
          ...
          className="cursor-pointer flex items-center gap-2 rounded-md bg-sky-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-sky-700 focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-black focus:outline-none">
          Linkedin
        ...
        <a 
          ...
          className="cursor-pointer flex items-center gap-2 rounded-md border border-white/20 bg-white/10 px-6 py-2.5 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20 focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-black focus:outline-none">
          Github
